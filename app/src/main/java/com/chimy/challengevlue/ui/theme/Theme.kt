package com.chimy.challengevlue.ui.theme
...
private val DarkColorScheme = darkColorScheme(
    ...
    onPrimary = OnBlueDarkPrimary,
    secondary = BlueDarkSecondary,
    onSecondary = OnBlueDarkSecondary,
    tertiary = BlueDarkTertiary,
    background = BlueDarkBackground,
    onBackground = OnBlueDarkBackground,
    surface = BlueDarkSurface,
    onSurface = OnBlueDarkSurface
)

@Composable
fun ChallengeVlueTheme(
